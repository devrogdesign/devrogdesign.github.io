...
<section className="cta-banner blur section section__padding-off" id="cta-banner">
    <div className="bd-container">
        <div className="cta-banner__container wrapper wrapper__center">
            ...
            <p className="about__description support-copy text-xl font-medium">No quiero ser un freelancer del montón y ofrecerte una plantilla más que no colme tus expectativas, sino ofrecerte una solución enfocada a tus usuarios que veas reflejada en el crecimiento de tu negocio.</p>
